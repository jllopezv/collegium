...
class AppSettingPageController extends Controller
{
    use HasCommon;

    protected $table='app_setting_pages';
    protected $module='setting';
    protected $model=AppSettingPage::class;
    protected $title;
    protected $subtitle;
    ...
    public function __construct()
    {
        ...
        $this->subtitle='Define las páginas de catalogación de las configuraciones';
    }
