...
class WebsiteAdvertisementController extends Controller
{
    use HasCommon;

    protected $table='website_advertisements';
    protected $module='website';
    protected $model=WebsiteAdvertisement::class;
    protected $title;
    protected $subtitle;
