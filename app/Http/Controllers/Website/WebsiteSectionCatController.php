...
class WebsiteSectionCatController extends Controller
{
    use HasCommon;

    protected $table='website_section_cats';
    protected $module='website';
    protected $model=WebsiteSectionCat::class;
    protected $title;
    protected $subtitle;
    ...
    public function __construct()
    {
        ...
        $this->subtitle='Categorías de Secciones';
    }
