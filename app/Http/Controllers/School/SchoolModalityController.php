...
class SchoolModalityController extends Controller
{
    use HasCommon;

    protected $table='school_modalities';
    protected $module='school';
    protected $model=SchoolModality::class;
    protected $title;
    protected $subtitle;
    ...
    public function __construct()
    {
        ...
        $this->subtitle='Modalidades escolares';
    }
