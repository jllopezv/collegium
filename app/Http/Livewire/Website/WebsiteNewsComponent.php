...
class WebsiteNewsComponent extends Component
{
    use WithPagination;
    use HasCommon;
    ...
    {
        $handlerimg=Image::make($path)->resize(appsetting('news_default_width'), appsetting('news_default_height'), function ($constraint) {
