...
class WebsitePostCatComponent extends Component
{
    use WithPagination;
    use HasCommon;
    ...
    {
        return [
            'category'         => 'required|string|max:255|unique:website_post_cats,category,'.$this->recordid,
    ...
    {
        $levels=WebsitePostCat::active()->count();
