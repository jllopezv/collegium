...
class WebsiteNewsCatComponent extends Component
{
    use WithPagination;
    use HasCommon;
    ...
    {
        return [
            'category'         => 'required|string|max:255|unique:website_news_cats,category,'.$this->recordid,
    ...
    {
        $levels=WebsiteNewsCat::active()->count();
