...
class WebsiteSectionCatComponent extends Component
{
    use WithPagination;
    use HasCommon;
    ...
    {
        $this->table='website_section_cats';
        $this->module='website';
        $this->commonMount();
    ...
    {
        return [
            'category'         => 'required|string|max:255|unique:website_section_cats,category,'.$this->recordid,
    ...
    {
        $levels=WebsiteSectionCat::active()->count();
