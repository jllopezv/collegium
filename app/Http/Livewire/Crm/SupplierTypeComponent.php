...
class SupplierTypeComponent extends Component
{
    use WithPagination;
    use HasCommon;
    ...
    {
        return [
            'type'              => 'required|string|max:255|unique:supplier_types,type,'.$this->recordid, //|unique:school_grades,grade,'.$this->recordid,
        ];
    }
