...
class EmployeeTypeComponent extends Component
{
    use WithPagination;
    use HasCommon;
    ...
    {
        return [
            'type'              => 'required|string|max:255|unique:employee_types,type,'.$this->recordid, //|unique:school_grades,grade,'.$this->recordid,
        ];
    }
