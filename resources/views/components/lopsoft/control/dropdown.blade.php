<div x-cloak x-data="{showselect: false}"
    ...
    <input type='text' class='w-full px-1 pb-1 transition-all duration-300 border-t-0 border-b-2 border-l-0 border-r-0 border-gray-300 rounded-none form-input hover:border-gray-500 hover:shadow-none active:border-gray-500 active:shadow-none focus:border-gray-500 focus:shadow-none' />
    @php
        $options=[];
