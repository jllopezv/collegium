...
@section('header')
    ...
    <x-lopsoft.datatable.header-th class='w-full' sortable sortorder='{{ $sortorder }}' columnname='name'>{{ transup('name') }}</x-lopsoft.datatable.header-th>
    <x-lopsoft.datatable.header-th class='w-44' sortable sortorder='{{ $sortorder }}' columnname='username'>{{ transup('username') }}</x-lopsoft.datatable.header-th>
