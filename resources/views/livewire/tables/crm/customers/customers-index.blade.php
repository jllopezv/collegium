...
@section('header')
    ...
    @endif
    <x-lopsoft.datatable.header-th class='w-80' sortable sortorder='{{ $sortorder }}' columnname='customer'>{{ transup('customer')}}</x-lopsoft.datatable.header-th>
    ...
    <x-lopsoft.datatable.header-th class='w-40' sortable sortorder='{{ $sortorder }}' columnname='customer_type_id' >{{ transup('type')}}</x-lopsoft.datatable.header-th>
@endsection
    ...
    <div class='flex flex-wrap items-center justify-start'>
        <div class='w-full mr-2 md:w-auto'>
            @livewire('controls.index-filter-component', [
                ...
                'options'       => \App\Lopsoft\LopHelp::getFilterDropdownBuilder(\App\Models\Crm\CustomerType::query(), 'id', 'type', '', true, 'type'),
                'defaultvalue'  => '*',
