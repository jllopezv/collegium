<div x-data='{}' x-show='$wire.showdialog' class='bg-transparent relative'>
    ...
    <x-lopsoft.control.inputform
        ...
        label='BUSCAR'
        id='searchsupplier'
        placeholder="Nombre del suplidor. Use * para listar todos"
                ...
                <div class='flex flex-wrap items-center justify-center md:justify-start w-full '>
                    <div class='w-full md:w-80 '>
                        <div class='text-center md:text-left'>
                            <a href="{{route('suppliers.show', ['id' => $item->id])}}" target='_blank'><i class='fa fa-info-circle text-cool-gray-400 hover:text-blue-500'></i></a><span class='ml-2'>{{$item->supplier}}</span>
                        </div>
                    </div>
