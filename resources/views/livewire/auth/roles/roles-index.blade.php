        ...
        <x-lopsoft.datatable.mainlayout
            ...
            <x-slot name="header">
                <x-lopsoft.datatable.header-tr>
                    ...
                    <x-lopsoft.datatable.header-th class='w-60' sortable sortorder='{{ $sortorder }}' columnname='role'>ROLE</x-lopsoft.datatable.header-th>
                    <x-lopsoft.datatable.header-th class='w-3/4' sortable sortorder='{{ $sortorder }}' columnname='level'>NIVEL</x-lopsoft.datatable.header-th>
